  ...
  <div class="card text-center">
    <div class="card-body">
      <div style="width:100%;min-height:380px" id="chart{{$i}}">
        <img src="ajax_loader_gray_128.gif" alt="loading...">
      </div>
    </div>
  </div>
</div>
@endfor
<!-- <button type="button" id="hiddenBtn" data-toggle="modal" data-target="#loadingModal" hidden></button>
<div class="modal fade" id="loadingModal" data-backdrop="false" tabindex="-1" role="dialog">
