<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav">
      <li class="nav-item nav-meal"><a class="nav-link" href="/meal"><span data-feather="slack"></span>&nbsp;Meal&nbsp;</a></li>
      <li class="nav-item nav-event"><a class="nav-link" href="/event"><span data-feather="activity"></span>&nbsp;Event&nbsp;</a></li>
